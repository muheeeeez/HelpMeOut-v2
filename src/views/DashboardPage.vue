  ...
  <div class="first">
      ...
      <div class="profile-bar">
        <li>
          <div class="profile" @click="menuView">
            <img src="../assets/images/profile-circle.png" alt="" />
          ...
          <div class="dropdown-menu" v-if="menuIsViewed">
            <ul>
              <li class="listing">
                <img src="../assets/images/setting-2.png" alt="" /><router-link>
                  Settings and Privacy</router-link
                >
                <img src="../assets/images/arrow-right.png" alt="arrow-right" />
              </li>
              <li class="listing">
                <img src="../assets/images/moon.png" alt="" /><router-link
                  >Display and Accessibility</router-link
                ><img src="../assets/images/arrow-right.png" alt="arrow-right" />
              </li>
              <li class="listing">
                <img src="../assets/images/message-question.png" alt="" /><router-link
                  >Help and Support</router-link
                ><img src="../assets/images/arrow-right.png" alt="arrow-right" />
              </li>
              <li class="listing" @click="logout">
                <img src="../assets/images/logout.png" alt="" /><router-link>Logout</router-link>
              </li>
            </ul>
          </div>
        </li>
    ...
    <div class="container">
      <div class="first-container">
        ...
        <input type="text" placeholder="Save video as" v-model="videoName" />
        <button @click="startRecording" :disabled="isRecording">Start Recording</button>
        <!-- Stop Recording button removed -->
      ...
      <div>
        <input type="text" class="second-container" placeholder="Search for a particular video" />
      </div>
    </div>
  </div>
  <div>
...
const startRecording = async () => {
  try {
    ...
    // Listen for the 'ended' event on each screen track
    ...
    webcamStream = await navigator.mediaDevices.getUserMedia({
      video: { width: 200, height: 150 }, // Small overlay webcam
      audio: false, // Avoid double audio
    })

    // Optional: Listen for the 'ended' event on each webcam track
    ...
    console.log('Merging screen & webcam streams...')
    const combinedStream = new MediaStream([
      ...screenStream.getTracks(),
      ...webcamStream.getVideoTracks(), // Add webcam video
    ])
...
const uploadVideo = async (blob) => {
  try {
    ...
    uploadTask.on(
      ...
      async () => {
        ...
        try {
          ...
          // Save the download URL to Firestore in the 'videos' subcollection
          ...
          console.log('Video metadata added to Firestore.')
          ...
          console.error('Error obtaining download URL or updating Firestore:', err)
    ...
    toast.error('An error occurred during upload: ' + err.message, { position: 'top-right' })
  }
}
  ...
  if (user) {
    ...
    unsubscribeUserData = onSnapshot(
      ...
      (err) => {
        ...
        uploadError.value = 'Failed to fetch user data.'
