<template>
  <div class="top" id="features">
    ...
    <div class="container">
      <div class="content-container">
        <div class="left-content-container">
          <div class="details">
            ...
            <div class="details-text text-details">
              <h1>Simple Screen Recording</h1>
              <p>
      ...
      <div class="image">
        <img src="../assets/images/Video.jpg" alt="videopage" />
      </div>
    </div>
  </div>
</template>
...
<style scoped>
@import url("https://fonts.googleapis.com/css2?family=Sora:wght@700&family=Work+Sans:wght@500&display=swap");
